...
public class Snippets {
    ...
    void browser_command_examples() {
        ...
        open("/customer/orders"); //относительный путь
        ...
        Selenide.switchTo().window("The Internet"); //с т.з. Селенида та же фигня, что и фрейм
    }
    ...
    void actions_examples() {
        ...
        $("").setValue("text"); //очищает поле и пишет
        $("").append("text"); //добавляет в поле
        $("").clear();
        $("").setValue(""); //clear
    ...
    void conditions_examples() {
        ...
        $("").shouldHave(text("abc")); //case insensitive
